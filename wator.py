...
def wator():
    ...
    run_simulation(args.x, args.y, sharks, fishes, args.traditional, args.chronons, args.sharkspawn, args.sharkstarve, args.fishspawn, args.Commit, args.File, args.Restore, args.Save, random)
    

def run_simulation(x,y,s,f,traditional,chronons,sharkspawn,sharkstarve,fishspawn, commit, file, restore, save, random):
    """
